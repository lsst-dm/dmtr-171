...
The test went better than expected. ~ All files generated well with no
intervention, ~the files transferred but we found that the SCP protocol
that was used was VERY inefficient for transferring small files over a
long haul network. ~ During the tests, the team wasn't sure if the LHN
was really being used, and what the ``data transfer'' time really was.~~
...
been handy to have someone on the team that can check the LHN to see if
we used the LHN, backup networks, and what the speeds of the LHN. ~ We
will add a networking person to the OR team. ~\\[2\baselineskip]
